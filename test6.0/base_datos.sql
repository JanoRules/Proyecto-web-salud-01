...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-10-2024 a las 04:13:27
...
INSERT INTO `login` (`id`, `rut`, `username`, `password`, `intentos_fallidos`, `tiempo_bloqueo`) VALUES
(1, '22.016.050-5', 'nicolas.fuentes2024', '$2y$10$kW9OsyZwf3jssb142i3GVeUlHFGcl/RYsmKtTFKIRMxMfuCUevIXu', 0, NULL),
(2, '132006005', 'vegetta777', '$2y$10$AlvYFpa0vRDyY1sa/NYHOukiKwvK2OX.05QMU7RsUKAf0IUMaMahu', 0, NULL),
(4, '145008005', 'willyrex', '$2y$10$dde8O0RO9ySTTOm0vALyHescmULIUIxKY.nLv0gIUb/56o5/04FKC', 0, NULL),
(5, '125135405', 'kylianmbappe7', '$2y$10$uWPsUhBajAsXwa0JIdywxO4lhDMRrcG66VRgxibDG9yny06aSDnsm', 0, NULL),
(6, '214445552', 'Maxpayne', '$2y$10$RCgZ8m56yaSV1.skvvYDmugfSrQ212beCfVplYNuLv0JKnoveHTWO', 0, NULL),
(7, '19.800.695-1', 'nfuentes', '$2y$10$GBFHkJCGd5.fKJJ2AaOQleVdPJw3BhrBJgAd.wE/mUrk7g9o6H5Ou', 0, NULL),
(8, '200806008', 'Montapuercos', '$2y$10$Mh1Q0ywx/srLi88P3lGFaORidWiWJkGi3cyusTQq1j7KxQehR3cKS', 0, NULL),
(9, '345748374', 'Slayer', '$2y$10$j/XaHWUJxZ1tocDTRGtXCO59ACQezoGHIhnJtm91Vm5ZMenX6CV2a', 0, NULL);
...
(10, '345748374', 'Ariel', 'Diaz', 'Si@gmail.com', '2024-10-04', 'Temuco');
...
(1, 'Slayer', 'dfdfdfdf', 3, 'dfsdfs', '2024-10-16 00:57:11');
...
--
-- Filtros para la tabla `busquedas_servicios`
--
ALTER TABLE `busquedas_servicios`
  ADD CONSTRAINT `busquedas_servicios_ibfk_1` FOREIGN KEY (`servicio_id`) REFERENCES `servicios` (`id`),
  ADD CONSTRAINT `busquedas_servicios_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `login` (`id`);

--
-- Filtros para la tabla `favoritos`
--
ALTER TABLE `favoritos`
  ADD CONSTRAINT `favoritos_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `login` (`id`),
  ADD CONSTRAINT `favoritos_ibfk_2` FOREIGN KEY (`centro_salud_id`) REFERENCES `centros_salud` (`id`);
